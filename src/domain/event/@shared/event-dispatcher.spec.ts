...
import SendEmailWhenCustomerIsUpdatedHandler from "../customer/handler/send-email-when-customer-is-updated.handler";
import SendMessageKafkaWhenCustomerIsCreatedHandler from "../customer/handler/send-message-kafka-when-customer-is-created.handler";
